...
public class DemoApplication {
    ...
    public static void main(String[] args) {
        ...
        Smartphone smartphone = new Smartphone("SAMSUNG" ,producer, "Galaxy S20", 6.3, 8, 256, 3, 12000000, 1, 20000000, 4300, "Exynos", "https://image.ceneostatic.pl/data/products/91074694/i-samsung-galaxy-s20-plus-5g-sm-g986-128gb-szary.jpg");
